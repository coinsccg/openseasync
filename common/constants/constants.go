...
const (
	...
	URL_OPENSEA_OWNER_ASSETS            = "/opensea/assets/:user"
	URL_OPENSEA_ASSETS_CONTRACT_TOKENID = "/opensea/asset/:contract_address/:token_id"
	URL_OPENSEA_OWNER_Collections       = "/opensea/collections/:user"
	URL_FIND_ASSET                      = "/assets/:user"
	URL_FIND_COLLECTION                 = "/collections/:user"
	URL_FIND_ASSETS_SLUG                = "/assets/:user/:slug"
